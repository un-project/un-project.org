...
ALTER TABLE public.resolutions
    ...
    ADD COLUMN IF NOT EXISTS important_vote BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS issue_me BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS issue_nu BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS issue_co BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS issue_hr BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS issue_ec BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS issue_di BOOLEAN NOT NULL DEFAULT FALSE;
