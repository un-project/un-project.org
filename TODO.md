...
- [ ] **Mobile nav** — the top nav dropdown is hover-only; add a hamburger toggle for small screens.
...
- [ ] **Country comparison** — select two countries to view their voting records side by side: agreement rate, divergence on specific topics, alignment chart.
...
- [ ] **Sitemap** — generate `sitemap.xml` covering meetings, countries, speakers, and resolutions for SEO.
...
- [ ] **Rate limiting** — add basic rate limiting to the search and API endpoints.
