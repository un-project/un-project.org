...
class RelationCreationForm(FormRenderer, forms.ModelForm):
    ...
    relation_type = forms.ChoiceField(choices=Relation.TYPES, widget=forms.RadioSelect)
    ...
    def clean_target_noun(self):
        ...
        return target_noun.lower().strip()
    ...
    def get_target(self):
        ...
        try:
            noun = Noun.objects.get(
                text=target_noun, language=normalize_language_code(get_language())
            )
