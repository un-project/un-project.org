...
from declarations.models import (
    Resolution, Declaration, Report, FALLACY_TYPES, DECLARATION_TYPES)
...
class DeclarationsSerializer(serializers.ModelSerializer):
    ...
    declaration_type = serializers.ChoiceField(
        required=True, choices=DECLARATION_TYPES)

    class Meta:
        model = Declaration
        fields = ('id', 'user', 'text', 'sources', 'parent',
                  'absolute_url', 'declaration_type',
...
class ResolutionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'user', 'title', 'slug', 'description',
                  'owner', 'sources', 'declarations', 'date_creation',
